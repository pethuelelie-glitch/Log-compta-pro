                ...
                <CardContent className="p-4">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-1 shrink-0">
                      ...
                      <Button size="sm" variant="ghost" onClick={() => setConfirmDel(c.id)}>
    ...
    <DialogContent>
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <Input value={telephone ?? ""} onChange={(e) => setTel(e.target.value)} />
        </div>
        <div className="space-y-2">
          <Label>Email</Label>
        ...
        <div className="space-y-2">
          <Label>Adresse</Label>
          <Input value={adresse ?? ""} onChange={(e) => setAdr(e.target.value)} />
        </div>
        <DialogFooter>
